                        ...
                        <div class="col-md-12">
                            <div class="nav-tabs-custom">
                                <ul class="nav nav-tabs">
                                    <li><?php echo anchor('admin/prefs_interfaces/admin', trans('menu_int_admin')); ?></li>
                                    <li class="active"><?php echo anchor('admin/prefs_interfaces/public', trans('menu_int_public')); ?></li>
                                </ul>
                                            ...
                                            <div class="form-group">
                                                <div class="col-sm-offset-2 col-sm-10">
                                                    <div class="btn-group">
                                                        ...
                                                        <?php echo anchor('admin/reset_interfaces_public', trans('actions_default_values'), array('class' => 'btn btn-danger btn-flat')); ?>
                                                    </div>
                                                </div>
                                            </div>
                                        <?php echo form_close();?>
