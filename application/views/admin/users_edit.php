            ...
            <div class="col-md-12">
                <div class="box">
                    <div class="box-header with-border">
                        <h3 class="box-title"><?php echo trans('users_edit_user'); ?></h3>
                    </div>
                    <div class="box-body">
                        <?php echo $message; ?>
                        ...
                        <div class="form-group">
                            <?php echo trans('new_users_password', 'password', array('class' => 'col-sm-2 control-label')); ?>
                            <div class="col-sm-10">
                        ...
                        <div class="form-group">
                            <?php echo trans('confirm_new_users_password', 'password_confirm', array('class' => 'col-sm-2 control-label')); ?>
                            <div class="col-sm-10">
                        ...
                        <?php if ($this->ion_auth->is_admin()) : ?>
                            <div class="form-group">
                                <label class="col-sm-2 control-label"><?php echo trans('users_member_of_groups'); ?></label>
                                <div class="col-sm-10">
